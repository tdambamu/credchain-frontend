...
const roleOptions: { label: string; value: BackendRole }[] = [
  { label: 'System admin', value: 'ROLE_SYSTEM_ADMIN' },
  { label: 'Institution admin', value: 'ROLE_INSTITUTION_ADMIN' },
  { label: 'Issuer', value: 'ROLE_ISSUER' },
...
const UsersPage: React.FC = () => {
  ...
  const [selectedRoles, setSelectedRoles] = useState<BackendRole[]>(['ROLE_ISSUER'])
    ...
    try {
      ...
      const filteredUsers =
        isInstitutionAdmin && myInstitutionId
          ? usersRes.filter(u => u.institutionId === myInstitutionId)
          : usersRes
      setUsers(filteredUsers)
      const filteredInst =
        isInstitutionAdmin && myInstitutionId
          ? instRes.filter(i => i.id === myInstitutionId)
          : instRes
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    const baseInstitutionId = isInstitutionAdmin && myInstitutionId
      ? myInstitutionId
